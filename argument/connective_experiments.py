...
#		feature.andFeature2(conn,node.nodeName,nodeDict,wordList[conn[0]].conn,discourseFile.rawFileName,wordList[conn[0]].sentenceNum)
...
#		feature.isseFeature(conn,node.nodeName,nodeDict,wordList[conn[0]].conn,discourseFile.rawFileName,wordList[conn[0]].sentenceNum)
		...
		print "lala",feature.featureList[-1]
...
for discourseFileLocation in discourseFileCollection:
	...
	totalSentenceCount+=len(discourseFile.sentenceList)
	...
	fileNum+=1
print totalWordCount,totalSentenceCount
