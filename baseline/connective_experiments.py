...
#FD=codecs.open("ke_baad","w")
#for featureDesc in featureCollectionDescSingle:
#	print featuredesc.attrlist
#	if(getattr(featuredesc,"single connective")==u'\u0915\u0947 \u092c\u093e\u0926'):
...
print "Accuracy",round(min_acc*100,2),"-",round(max_acc*100,2),"-",round(c*100.0/time,2)
basicAnalysis(errorCollection,"connective_all_runs")
